class CommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comment.save
        format.html { redirect_to @comment.rally, notice: 'Comment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to @comment.rally, notice: 'Comment was successfully updated.' }
